...
WindPowerSystemV5 is a test web application developed as a learning project to explore integration between **ASP.NET Core 8, Angular 17, Entity Framework Core, and the MSSQL database**. 
