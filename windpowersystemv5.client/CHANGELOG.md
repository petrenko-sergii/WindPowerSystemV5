...
- Create Angular project with ng: `ng new windpowersystemv5.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`windpowersystemv5.client.esproj`).
